...
use App\Http\Controllers\Dashboard\BeritaAcaraController;
...
route::get('/admin/dashboard/kelola/surat_suara',[VotePapperController::class, 'index'])->name('kelola_surat')->middleware('auth');
